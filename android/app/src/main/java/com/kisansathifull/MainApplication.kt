...
class MainApplication : Application(), ReactApplication {
  ...
  private fun initializeFlipper() {
    ...
    try {
      val flipperClass = Class.forName("com.kisansathifull.ReactNativeFlipper")
      ...
      // Flipper is optional in this project; ignore when class is absent in CI/release.
    }
  }
